...
import { forwardRef, useReducer, createContext, useContext, useState, useRef, useCallback, useEffect, useMemo, memo, Fragment as Fragment$1 } from "react";
...
import { MinusIcon, PlusIcon, XMarkIcon as XMarkIcon$1, ChevronDownIcon, ShoppingCartIcon, MagnifyingGlassIcon, Bars3Icon, MagnifyingGlassPlusIcon, ChevronLeftIcon as ChevronLeftIcon$1, ChevronRightIcon as ChevronRightIcon$1 } from "@heroicons/react/24/outline";
import { Controller, useForm } from "react-hook-form";
import { useRemixFormContext, getValidatedFormData, useRemixForm, RemixFormProvider } from "remix-hook-form";
...
import { motion as motion$1, AnimatePresence } from "framer-motion";
...
const QuantitySelector = ({ className, variant, maxInventory = 100, onChange }) => {
  ...
  const handleDecrement = (currentValue, fieldOnChange) => {
    const newValue = Math.max(1, currentValue - 1);
    fieldOnChange(newValue);
    onChange == null ? void 0 : onChange(newValue);
  };
  const handleIncrement = (currentValue, fieldOnChange) => {
    const newValue = Math.min(variantInventory, parseInt(currentValue.toString()) + 1);
    fieldOnChange(newValue);
    onChange == null ? void 0 : onChange(newValue);
  };
  const handleInputChange = (value, fieldOnChange) => {
...
const LineItemQuantitySelect = ({
  ...
  const debouncedChange = debounce((quantity) => {
    fetcher.submit(
      {
        lineItemId: item.id,
        quantity
...
const CartDrawerItem = ({ item, currencyCode, isRemoving }) => {
  ...
  useFetcher({ key: FetcherKeys.cart.updateLineItem });
      ...
      children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "ml-4 flex flex-1 flex-col", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
            /* @__PURE__ */ jsx("p", { className: "text-sm  text-gray-500", children: /* @__PURE__ */ jsx(LineItemQuantitySelect, { formId: `quantity-${item.id}`, item }) }),
...
function getVariantFromSelectedOptions(product2, selectedOptions) {
  var _a;
  const validSelections = Object.entries(selectedOptions).filter(([_, value]) => value !== "");
  if (validSelections.length === 0) {
    return void 0;
  }
  return (_a = product2.variants) == null ? void 0 : _a.find((variant) => {
    return validSelections.every(([optionId, selectedValue]) => {
      var _a2;
      const variantOption = (_a2 = variant.options) == null ? void 0 : _a2.find((option) => option.option_id === optionId);
      return (variantOption == null ? void 0 : variantOption.value) === selectedValue;
    });
  });
}
...
const ProductVariantPrice = ({ variant, currencyCode }) => {
  ...
  return /* @__PURE__ */ jsx(Fragment, { children: hasSale ? /* @__PURE__ */ jsxs("span", { className: "inline-flex items-center gap-1", children: [
...
const ProductThumbnail = ({ product: product2, className, isTransitioning, classNameImage, isRemoveStyleDefault = false, forcedZoom, ...props }) => {
  ...
  return /* @__PURE__ */ jsxs(
    "figure",
    {
      ...
      ...props,
      children: [
        /* @__PURE__ */ jsx(MorphingShape, { ...randomAssetMorphingShape(product2.subtitle), zoom: forcedZoom, classNameWrapper: clsx(isRemoveStyleDefault && "!h-auto") }),
...
const ProductSuggestionItem = ({
  ...
  const defaultOptions = useMemo(() => {
    ...
    if (firstVariant && firstVariant.options && firstVariant.options.length > 0) {
      ...
      if (product2.options && product2.options.length > 0) {
        const missingOptions = product2.options.filter(
      ...
      console.log("✅ Product options:", (_b = product2.options) == null ? void 0 : _b.map((opt) => ({ id: opt.id, title: opt.title })));
      return options;
    }
    if (product2.options && product2.options.length > 0) {
  ...
  const selectedOptions = useMemo(() => {
    ...
    return product2.options.map(({ id }) => controlledOptions[id]).filter((opt) => Boolean(opt));
  ...
  const selectedVariant = useMemo(() => {
    ...
    const allOptionsSelected2 = product2.options.every((option) => {
      if (!option.id) return false;
      const value = controlledOptions[option.id];
      return value && value !== "";
    });
    if (!allOptionsSelected2) {
      console.log("⚠️ Not all options selected. controlledOptions:", controlledOptions);
      console.log("⚠️ Product options:", product2.options.map((opt) => ({ id: opt.id, title: opt.title })));
      return void 0;
    }
    const orderedSelectedOptions = product2.options.map(({ id }) => controlledOptions[id]).filter((opt) => Boolean(opt));
    if (orderedSelectedOptions.length !== product2.options.length) {
      console.log("⚠️ Selected options count mismatch:", {
        selected: orderedSelectedOptions.length,
        required: product2.options.length,
    ...
    if (!variant) {
      ...
      variant = getVariantFromSelectedOptions(product2, controlledOptions);
      console.log("variant", variant, product2, controlledOptions);
      if (variant) {
    ...
    return variant;
  }, [variantMatrix, controlledOptions, product2]);
  ...
  const canAddToCart = useMemo(() => {
    ...
    console.log("Result:", result, "(allOptionsSelected:", allOptionsSelected, ", selectedVariant:", selectedVariant !== void 0, ")", selectedVariant);
    return result;
  ...
  return /* @__PURE__ */ jsxs(
    "article",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-4 justify-center", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex gap-2", children: [
            ...
            productSelectOptions && productSelectOptions.length > 0 && /* @__PURE__ */ jsx("div", { className: "flex flex-col gap-2", children: productSelectOptions.map((option) => {
              ...
              return /* @__PURE__ */ jsx("div", { className: "flex flex-col gap-1", children: /* @__PURE__ */ jsx("div", { className: "flex flex-wrap gap-2", children: filteredValues.map((value) => {
...
const ProductSwiperBase = ({ className, heading, text, actions: actions2, ...props }) => {
...
const CartDrawerContent = ({ items, isRemovingItemId, isAddingItem, showEmptyCartMessage, isRemovingLastItem, currencyCode }) => {
  ...
  return /* @__PURE__ */ jsx("div", { className: clsx(!hasItems && !isAddingItem ? "flex flex-1 h-full items-center mt-0 justify-center" : "mt-8"), children: /* @__PURE__ */ jsxs("div", { className: "flow-root", children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "fixed inset-0 overflow-hidden", children: /* @__PURE__ */ jsx("div", { className: "absolute inset-0 overflow-hidden", children: /* @__PURE__ */ jsx("div", { className: "pointer-events-none fixed inset-y-0 right-0 flex max-w-full pl-10", children: /* @__PURE__ */ jsx(
      DialogPanel,
      {
        ...
        children: /* @__PURE__ */ jsxs("div", { className: "flex h-full flex-col overflow-y-scroll bg-white shadow-xl", children: [
          ...
          ) : /* @__PURE__ */ jsx(CartDrawerEmptyFooter, {})
        ] })
      }
    ) }) }) })
  ] });
...
const ProductPriceRange = ({ product: product2, currencyCode }) => {
  ...
  return /* @__PURE__ */ jsx(Fragment, { children: hasPriceRange ? /* @__PURE__ */ jsxs(Fragment, { children: [
    formatPrice(minPrice, { currency: currencyCode }),
    maxPrice && maxPrice > minPrice ? /* @__PURE__ */ jsxs(Fragment, { children: [
      "–",
...
const ProductSearch = ({
  ...
  const handleProductClick = (product2) => {
    navigate(`/products/${product2.handle}`);
    setOpen(false);
    setSearchQuery("");
    setResults([]);
    setIsOpen(false);
  };
  const getThumbnailUrl = (product2) => {
    if (product2.thumbnail) return product2.thumbnail;
    if (product2.images && product2.images.length > 0) {
      return product2.images[0].url || null;
    }
    return null;
  };
  const { region } = useRegion();
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsx(Container, { className: "relative", children: /* @__PURE__ */ jsx("div", { className: "xl:px-[96px] max-w-[1268px] relative mx-auto", children: /* @__PURE__ */ jsxs(
      motion.div,
      {
        ...
        children: [
          /* @__PURE__ */ jsxs("div", { className: "relative flex items-center", children: [
            ...
            isLoading && /* @__PURE__ */ jsx("div", { className: "absolute right-3 flex items-center gap-1", children: /* @__PURE__ */ jsx("div", { className: "w-4 h-4 border-2 border-gray-300 border-t-blue-500 rounded-full animate-spin" }) }),
            !isLoading && /* @__PURE__ */ jsx("div", { className: "absolute right-3 flex items-center gap-1", children: /* @__PURE__ */ jsx(IconButton, { icon: XMarkIcon$1, onClick: () => {
              if (!searchQuery.trim()) {
                setOpen(false);
              }
              setSearchQuery("");
          ...
          isOpen && /* @__PURE__ */ jsx("div", { className: "absolute top-full left-0 right-0 mt-2 bg-white border border-gray-200 rounded-lg shadow-lg z-50 max-h-96 overflow-y-auto", children: error ? (
            /* Error Message */
            /* @__PURE__ */ jsxs("div", { className: "p-4 text-center text-red-600 text-sm", children: [
              "Error: ",
              error
            ] })
          ) : results.length === 0 && !isLoading ? (
            /* No Results */
            /* @__PURE__ */ jsx("div", { className: "p-4 text-center text-gray-500 text-sm", children: "No products found" })
          ) : (
            /* Product List */
            /* @__PURE__ */ jsx("ul", { className: "divide-y divide-gray-100", children: results.map((product2) => {
              const thumbnail = getThumbnailUrl(product2);
              return /* @__PURE__ */ jsxs(
                "li",
                {
                  ...
                  children: [
                    thumbnail && /* @__PURE__ */ jsx("div", { className: "flex-shrink-0 w-12 h-12 rounded-md overflow-hidden bg-gray-100", children: /* @__PURE__ */ jsx(
                      "img",
                      {
                        src: thumbnail,
                        alt: product2.title,
                    ...
                    /* @__PURE__ */ jsxs("div", { className: "flex-1 min-w-0", children: [
                      /* @__PURE__ */ jsx("h3", { className: "font-semibold text-gray-900 text-sm truncate", children: product2.title }),
                      /* @__PURE__ */ jsx(ProductPriceRange, { product: product2, currencyCode })
                    ] }),
                    /* @__PURE__ */ jsx("div", { className: "flex-shrink-0 flex items-center text-gray-400", children: /* @__PURE__ */ jsx("svg", { className: "w-5 h-5", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", children: /* @__PURE__ */ jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M9 5l7 7-7 7" }) }) })
                  ]
                },
                product2.id
              );
...
const CollectionMenuList = ({ open, setOpen }) => {
  const collections = [
    {
      id: "1",
  ...
  const collectionMenuListRef = useRef(null);
  useEffect(() => {
    const handleClickOutside = (event) => {
      if (collectionMenuListRef.current && !collectionMenuListRef.current.contains(event.target)) {
        setOpen(false);
      }
    };
    document.addEventListener("mousedown", handleClickOutside);
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsx(Container, { className: "relative", children: /* @__PURE__ */ jsx("div", { className: "xl:px-[96px] max-w-[1268px] relative mx-auto", children: /* @__PURE__ */ jsxs(
      motion.div,
      {
        ...
        transition: { duration: 0.3, ease: "easeOut", delay: 0.3 },
        children: [
          /* @__PURE__ */ jsx(IconButton, { icon: XMarkIcon$1, className: "absolute top-2 right-2 hover:!bg-transparent hover:text-gray-700 focus:text-gray-700 z-10 !text-primary", onClick: () => setOpen(false) }),
          /* @__PURE__ */ jsx("div", { className: "relative flex-col hidden xl:flex", children: collections.map((collection) => /* @__PURE__ */ jsx("div", { className: "flex items-center p-2 rounded-md last:font-bold", children: /* @__PURE__ */ jsx(Link, { to: `/collections/${collection.handle}`, onClick: () => setOpen(false), children: collection.title }) }, collection.id)) })
        ]
      }
    ) }) })
  ] });
...
const Header = () => {
  ...
  if (!headerNavigationItems2) return /* @__PURE__ */ jsx(Fragment, { children: "Loading..." });
  const openSubmenu = () => {
    setSubmenuOpen(true);
  };
  return /* @__PURE__ */ jsxs("header", { className: "sticky top-0 z-40 mkt-header bg-white mt-8", children: [
    /* @__PURE__ */ jsx("nav", { "aria-label": "Top", children: /* @__PURE__ */ jsx("div", { className: "bg-transparent", children: /* @__PURE__ */ jsx("div", { className: "", children: /* @__PURE__ */ jsx(Container, { children: /* @__PURE__ */ jsx(
      "div",
      {
        className: clsx(
        ...
        children: /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap-reverse justify-between w-full items-center", children: [
          /* @__PURE__ */ jsx(LogoStoreName, { className: "h-8 lg:h-14", primary: true }),
          headerNavigationItems2 && headerNavigationItems2.slice(0, 6).map(({ id, new_tab, ...navItemProps }, index) => /* @__PURE__ */ jsxs(
            URLAwareNavLink,
            {
              ...navItemProps,
              newTab: new_tab,
          ...
          /* @__PURE__ */ jsx("div", { className: "hidden xl:flex items-center justify-end", children: /* @__PURE__ */ jsx("div", { className: "flex items-center gap-x-3 text-sm", children: /* @__PURE__ */ jsx(
            IconButton,
            {
    ...
    /* @__PURE__ */ jsx(ProductSearch, { open: searchOpen, setOpen: setSearchOpen }),
    /* @__PURE__ */ jsx(
      HeaderSideNav,
      {
        activeSection,
    ...
    /* @__PURE__ */ jsx(CollectionMenuList, { open: submenuOpen, setOpen: setSubmenuOpen })
  ] });
};
...
const LiveChatIcon = memo(({
  ...
  return /* @__PURE__ */ jsxs("div", { className: `fixed bottom-6 left-6 z-50 ${className}`, children: [
    isOpen && /* @__PURE__ */ jsxs("div", { className: "absolute bottom-24 right-0 flex flex-col gap-3 mb-2 z-50", children: [
    ...
    /* @__PURE__ */ jsx(
      "button",
      {
        ...
        title: "Open chat",
        children: /* @__PURE__ */ jsx("span", { children: /* @__PURE__ */ jsx("img", { src: "/assets/images/livechat.gif", alt: "Chat", className: "xl:w-20 xl:h-20 w-10 h-10" }) })
      }
    ),
    isOpen && /* @__PURE__ */ jsx(
      "div",
    ...
    "div",
    {
      ...
      children: [
        ...
        !isHiddenHeader && /* @__PURE__ */ jsxs(Fragment, { children: [
          ...
          /* @__PURE__ */ jsx("div", { className: "fixed bottom-6 right-6 z-50", children: /* @__PURE__ */ jsx("button", { onClick: () => toggleCartDrawer(true), className: "transition-all duration-300 transform hover:scale-110 flex items-center justify-center", children: /* @__PURE__ */ jsx("span", { children: /* @__PURE__ */ jsx("img", { src: "/assets/images/cart.svg", alt: "Chat", className: "xl:w-32 xl:h-32 w-20 h-20" }) }) }) })
        ] })
      ]
    }
  );
...
const Pagination = ({
  ...
  return /* @__PURE__ */ jsx("div", { className: "flex items-center justify-between", children: /* @__PURE__ */ jsx("div", { className: "flex flex-1 flex-col-reverse flex-wrap items-center justify-center gap-4 sm:flex-row", children: /* @__PURE__ */ jsx("div", { children: /* @__PURE__ */ jsxs("nav", { className: "relative z-0 inline-flex", "aria-label": "Pagination", children: [
    ...
    startPage > 2 && /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    endPage < totalPages - 1 && /* @__PURE__ */ jsxs(Fragment, { children: [
      /* @__PURE__ */ jsx("span", { className: "relative inline-flex items-center bg-white px-3 py-2 text-sm font-bold text-gray-700 sm:px-4", children: "..." }),
      /* @__PURE__ */ jsx(
        PaginationItem,
        {
...
const collections_$collectionHandle = UNSAFE_withComponentProps(function ProductCollectionRoute() {
  ...
  return /* @__PURE__ */ jsxs(Container, {
    ...
    children: [/* @__PURE__ */ jsxs("h1", {
      className: "relative flex flex-col xl:flex-row items-center xl:items-end text-4xl xl:text-[110px] leading-normal xl:leading-[114px] text-[#321D14] mt-12 after:hidden xl:after:block after:content-[''] after:block after:w-1/2 after:h-[1px] after:bg-[#000000] after:absolute after:bottom-[32px] after:left-0",
      children: [/* @__PURE__ */ jsxs("p", {
        ...
        children: /* @__PURE__ */ jsxs("div", {
          className: "relative h-10 xl:h-20 w-10 xl:w-20 -top-10 xl:-top-16 -right-10 xl:-left-16 z-10",
...
async function action$9(actionArgs) {
  ...
  try {
    const result = await initiatePaymentSession(actionArgs.request, cart2, paymentSessionData);
    return data({
...
const ProductReviewView = ({
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    galleryImages && galleryImages.length > 0 && /* @__PURE__ */ jsxs(Fragment, { children: [
...
const ProductCategoryTabs = ({ categories, ...props }) => {
  ...
  return /* @__PURE__ */ jsx(Tab.Group, { ...props, children: /* @__PURE__ */ jsxs(TabList, { children: [
    /* @__PURE__ */ jsx(Tab, { as: Fragment$1, children: ({ selected }) => /* @__PURE__ */ jsx(TabButton, { selected, children: "All" }) }),
    categories.map((category) => /* @__PURE__ */ jsx(Tab, { as: Fragment$1, children: ({ selected }) => /* @__PURE__ */ jsx(TabButton, { selected, children: category.name }) }, category.id))
  ] }) });
};
const ProductCollectionTabs = ({ collections, ...props }) => {
  ...
  return /* @__PURE__ */ jsx(Tab.Group, { ...props, children: /* @__PURE__ */ jsxs(TabList, { children: [
    /* @__PURE__ */ jsx(Tab, { as: Fragment$1, children: ({ selected }) => /* @__PURE__ */ jsx(TabButton, { selected, children: "All" }) }),
    collections.map((collection) => /* @__PURE__ */ jsx(Tab, { as: Fragment$1, children: ({ selected }) => /* @__PURE__ */ jsx(TabButton, { selected, children: collection.title }) }, collection.id))
  ] }) });
};
...
const ProductList = memo(({ className, heading, text, actions: actions2, ...props }) => {
  return /* @__PURE__ */ jsx("section", { className: clsx(`mkt-section relative overflow-x-hidden`, className), ...props, children: /* @__PURE__ */ jsx("div", { className: "mkt-section__inner relative z-[2]", children: /* @__PURE__ */ jsxs(Container, { children: [
    /* @__PURE__ */ jsxs("p", { className: "text-center mb-12", children: [
      /* @__PURE__ */ jsx("span", { className: "text-4xl font-title font-extrabold xl:text-[64px] leading-normal xl:leading-[48px] uppercase", children: "Something" }),
      /* @__PURE__ */ jsx("span", { className: "text-4xl font-centuryBook italic xl:text-[64px] leading-normal xl:leading-[48px] pl-2", children: "New?" })
    ] }),
...
memo(({ galleryImages }) => {
  return /* @__PURE__ */ jsx(Fragment, { children: galleryImages.map((image, imageIndex) => /* @__PURE__ */ jsx(
    Tab,
    {
...
const ProductImageGallery = ({ product: product2, variantImage }) => {
  ...
  return /* @__PURE__ */ jsxs(TabGroup, { as: "div", className: "flex flex-col-reverse gap-4 lg:flex-row lg:gap-6", selectedIndex, onChange: setSelectedIndex, children: [
    gallery.length > 1 && /* @__PURE__ */ jsxs("div", { className: "xl:absolute xl:-bottom-8 flex justify-center w-full gap-4", children: [
      /* @__PURE__ */ jsx(
        TabList$1,
        {
          ref: scrollableDivRef,
          className: "flex flex-row gap-2 p-3 bg-[#D1D1D1] rounded-full",
          children: gallery.map((image, index) => /* @__PURE__ */ jsx(Tab, { className: "relative flex w-2 h-2 items-center justify-center cursor-pointer rounded-lg transition-all duration-200 focus:outline-none aria-selected:border-blue-500", children: ({ selected }) => /* @__PURE__ */ jsx(Fragment, { children: /* @__PURE__ */ jsx(
            "span",
            {
    ...
    productReviews && productReviews.length > 0 && /* @__PURE__ */ jsx("div", { className: "space-y-8", children: productReviews.map((review, reviewIndex) => {
      return /* @__PURE__ */ jsxs("div", { className: "py-8", children: [
        /* @__PURE__ */ jsxs("div", { className: " flex items-center justify-between", children: [
          ...
          /* @__PURE__ */ jsx("h3", { className: "px-1.5 font-title font-extrabold text-2xl xl:text-[32px] leading-normal xl:leading-[42px] tracking-normal uppercase line-clamp-1 text-center", children: review.name ?? "Anonymous" }),
...
const ProductReviewListWithPagination = ({
  ...
  className,
  ...props
}) => /* @__PURE__ */ jsx(Fragment, { children: /* @__PURE__ */ jsxs("div", { className, children: [
...
const ProductReviewSection = () => {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsxs("p", { className: "text-center", children: [
      /* @__PURE__ */ jsx("span", { className: "text-4xl font-title font-extrabold xl:text-[64px] leading-normal xl:leading-[48px] uppercase", children: "Customer" }),
      /* @__PURE__ */ jsx("span", { className: "text-4xl font-centuryBook italic xl:text-[64px] leading-normal xl:leading-[48px] pl-2", children: "Review" })
    ] }),
    /* @__PURE__ */ jsx("section", { id: "reviews", className: "container mx-auto my-6 xl:my-12 grid grid-cols-12 xl:px-8", children: /* @__PURE__ */ jsx(
...
const ProductTemplate = ({ product: product2 }) => {
  ...
  const defaultValues = {
    ...
    options: useMemo(() => {
      ...
      return ((_b2 = product2.options) == null ? void 0 : _b2.reduce(
        (acc, option) => {
          var _a3;
  ...
  const variantImage = useMemo(() => {
    return (selectedVariant == null ? void 0 : selectedVariant.thumbnail) || product2.thumbnail;
  }, [selectedVariant]);
            ...
            /* @__PURE__ */ jsxs(GridColumn, { className: "mb-8 md:col-span-6 xl:sticky xl:top-[144px] [height:min-content]", children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "flex gap-4 items-end justify-between", children: [
                /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-2", children: [
                  ...
                  /* @__PURE__ */ jsx("p", { className: "text-gray-900 font-bold flex gap-3", children: /* @__PURE__ */ jsx("span", { className: "text-3xl", children: selectedVariant ? /* @__PURE__ */ jsx(ProductPrice, { product: product2, variant: selectedVariant, currencyCode }) : /* @__PURE__ */ jsx(ProductPriceRange, { product: product2, currencyCode }) }) })
                ] }),
                /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-end gap-6", children: [
                  !soldOut && /* @__PURE__ */ jsx(QuantitySelector, { variant: selectedVariant, onChange: handleChange }),
...
async function action$2(actionArgs) {
  ...
  if ((activePaymentSession == null ? void 0 : activePaymentSession.provider_id) !== data$1.providerId || !((_e = (_d = cart2.payment_collection) == null ? void 0 : _d.payment_sessions) == null ? void 0 : _e.length)) {
    ...
    if (data$1.providerId === "pp_bank_transfer_bank_transfer") {
      const existingBankTransferSession = (_g = (_f = cart2.payment_collection) == null ? void 0 : _f.payment_sessions) == null ? void 0 : _g.find((ps) => ps.provider_id === "pp_bank_transfer_bank_transfer");
      if ((_h = existingBankTransferSession == null ? void 0 : existingBankTransferSession.data) == null ? void 0 : _h.bank_account_id) {
        paymentSessionData.data = {
    ...
    await initiatePaymentSession(actionArgs.request, cart2, paymentSessionData);
  }
...
const productsSearchSchema = z$1.object({
...
const listBankAccounts = async (cacheOptions = {}) => {
  return await cachified({
    key: `bank-accounts`,
    cache: sdkCache,
    staleWhileRevalidate: MILLIS.ONE_HOUR,
...
const blogs_$slugHandle = UNSAFE_withComponentProps(function BlogsIndexRoute() {
  ...
  return /* @__PURE__ */ jsxs("section", {
    children: [/* @__PURE__ */ jsxs(Container, {
      ...
      children: [post && /* @__PURE__ */ jsxs(Fragment, {
        children: [/* @__PURE__ */ jsxs("div", {
...
const AddressDisplay = ({ title, address, countryOptions }) => {
  ...
  return /* @__PURE__ */ jsxs("span", { children: [
    ...
    /* @__PURE__ */ jsxs("dd", { className: "mt-0.5", children: [
      (address == null ? void 0 : address.company) && /* @__PURE__ */ jsxs(Fragment, { children: [
        address == null ? void 0 : address.company,
        /* @__PURE__ */ jsx("br", {})
      ] }),
      address == null ? void 0 : address.address1,
      /* @__PURE__ */ jsx("br", {}),
      (address == null ? void 0 : address.address2) && /* @__PURE__ */ jsxs(Fragment, { children: [
      ...
      /* @__PURE__ */ jsx("br", {}),
      (address == null ? void 0 : address.countryCode) && /* @__PURE__ */ jsxs(Fragment, { children: [
...
const CheckoutOrderSummaryDiscountCode = ({ cart: cart2 }) => {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "mb-6", children: [
    ...
    isFormVisible && /* @__PURE__ */ jsxs(Fragment, { children: [
...
const HiddenAddressGroup = ({ address, prefix }) => {
  return /* @__PURE__ */ jsx(Fragment, { children: Object.keys(address).map((key) => {
    const castedKey = key;
...
const defaultStripeAddress = (address) => ({
  address: {
    firstName: (address == null ? void 0 : address.first_name) || "",
    lastName: (address == null ? void 0 : address.last_name) || "",
    address1: (address == null ? void 0 : address.address_1) || "",
    ...
    province: (address == null ? void 0 : address.province) || "",
    city: (address == null ? void 0 : address.city) || "",
    countryCode: (address == null ? void 0 : address.country_code) || "us",
    postalCode: (address == null ? void 0 : address.postal_code) || "",
    phone: (address == null ? void 0 : address.phone) || ""
  },
  completed: false
...
const CompleteCheckoutForm = ({
  ...
  var _a, _b;
  const { activePaymentSession, cart: cart2, isCartMutating } = useCheckout();
  const completeCartFetcher = useFetcher({ key: FetcherKeys.cart.completeCheckout });
  ...
  if (!cart2) return null;
  const defaultBillingAddress = medusaAddressToAddress(cart2.billing_address);
  const shippingAddress = defaultStripeAddress(cart2 == null ? void 0 : cart2.shipping_address) ?? emptyAddress;
  const countryOptions = ((_b = (_a = cart2.region) == null ? void 0 : _a.countries) == null ? void 0 : _b.map((country) => ({
    value: country.iso_2,
    label: country.display_name
  }))) ?? [];
  const defaultValues = {
  ...
  const handleSubmit = async (event) => {
    ...
    setSubmitting(true);
    const data2 = form.getValues();
    if (typeof onSubmit === "function") {
      return await onSubmit(data2, event, {
        setSubmitting,
  ...
  const PaymentSubmitButton = () => /* @__PURE__ */ jsx(
    SubmitButton,
    {
      form: id,
      className: "w-full lg:w-auto",
      disabled: isSubmitting || isCartMutating || !sameAsShipping && !billingAddress,
      children: isSubmitting ? "Confirming..." : submitMessage ?? "Confirm & Pay"
    }
  );
  if (!activePaymentSession) return null;
  return /* @__PURE__ */ jsx(Fragment, { children: /* @__PURE__ */ jsxs(RemixFormProvider, { ...form, children: [
    /* @__PURE__ */ jsxs(completeCartFetcher.Form, { id, onSubmit: handleSubmit, className, children: [
      /* @__PURE__ */ jsx(TextField, { type: "hidden", name: "cartId", value: cart2.id }),
      /* @__PURE__ */ jsx(TextField, { type: "hidden", name: "providerId", value: providerId }),
      /* @__PURE__ */ jsx("h3", { className: "text-lg font-bold text-gray-900", children: "Billing address" }),
      /* @__PURE__ */ jsx(Checkbox, { className: "my-4", name: "sameAsShipping", label: "Same as shipping address" }),
      !sameAsShipping && /* @__PURE__ */ jsx(MedusaStripeAddress, { mode: "billing", address: billingAddress, setAddress: setBillingAddress }),
      /* @__PURE__ */ jsx(HiddenAddressGroup, { address: billingAddress, prefix: "billingAddress" }),
      sameAsShipping && /* @__PURE__ */ jsx("div", { className: "-mt-2 mb-4", children: /* @__PURE__ */ jsx(AddressDisplay, { address: shippingAddress.address, countryOptions }) }),
      !hasPaymentMethods && /* @__PURE__ */ jsx("input", { type: "hidden", name: "paymentMethodId", value: "new" }),
      /* @__PURE__ */ jsx("div", { className: `stripe-payment-form ${initialPaymentMethodId !== "new" ? "hidden" : ""}`, children }),
      /* @__PURE__ */ jsx(FormError, {})
    ] }),
    /* @__PURE__ */ jsx("div", { className: "block lg:hidden", children: /* @__PURE__ */ jsx(CheckoutOrderSummary, { name: "checkout", submitButton: /* @__PURE__ */ jsx(PaymentSubmitButton, {}) }) }),
    /* @__PURE__ */ jsx("div", { className: "hidden lg:block", children: /* @__PURE__ */ jsx(PaymentSubmitButton, {}) })
  ] }) });
};
const ManualPayment = (props) => /* @__PURE__ */ jsx(
...
const BankTransferPayment = ({
  ...
  const bankAccountsFetcher = useFetcher();
  useEffect(() => {
  ...
  useEffect(() => {
    var _a2;
    if ((_a2 = bankAccountsFetcher.data) == null ? void 0 : _a2.bank_accounts) {
  ...
  useEffect(() => {
    var _a2;
    if ((_a2 = cart2 == null ? void 0 : cart2.payment_collection) == null ? void 0 : _a2.payment_sessions) {
      const bankTransferSession = cart2.payment_collection.payment_sessions.find(
        (session) => session.provider_id === "pp_bank_transfer_bank_transfer"
      );
      if (bankTransferSession && bankTransferSession.data) {
        const sessionData = bankTransferSession.data;
          ...
          if (bankAccounts.length > 0) {
            ...
            if (bankAccount) {
              setBankInfo({
                ...
                swiftCode: bankAccount.swift_code || void 0,
                qrCodeUrl: bankAccount.qr_code_url || void 0
              });
              return;
            }
          }
    ...
    setBankInfo(null);
  }, [(_a = cart2 == null ? void 0 : cart2.payment_collection) == null ? void 0 : _a.payment_sessions, bankAccounts]);
  const handleSelectBankTransfer = async () => {
    ...
    try {
      ...
      setBankInfo({
        ...
        bankName: ((_a2 = bankAccounts.find((bank) => bank.id === selectedBankAccountId)) == null ? void 0 : _a2.name) || "",
        accountHolder: ((_b2 = bankAccounts.find((bank) => bank.id === selectedBankAccountId)) == null ? void 0 : _b2.account_holder) || "",
        accountNumber: ((_c = bankAccounts.find((bank) => bank.id === selectedBankAccountId)) == null ? void 0 : _c.account_number) || "",
        bankCode: ((_d = bankAccounts.find((bank) => bank.id === selectedBankAccountId)) == null ? void 0 : _d.bank_code) || "",
        swiftCode: ((_e = bankAccounts.find((bank) => bank.id === selectedBankAccountId)) == null ? void 0 : _e.swift_code) || "",
        qrCodeUrl: ((_f = bankAccounts.find((bank) => bank.id === selectedBankAccountId)) == null ? void 0 : _f.qr_code_url) || ""
      });
    } catch (err) {
      setError(err.message || "Failed to select bank transfer payment");
    } finally {
      setIsLoading(false);
    }
  };
  return /* @__PURE__ */ jsxs("div", { className: "bank-transfer-payment space-y-4", children: [
    error && /* @__PURE__ */ jsx("div", { className: "bg-red-50 border border-red-200 text-red-700 px-4 py-3 rounded", children: error }),
    !bankInfo ? /* @__PURE__ */ jsxs("div", { className: "space-y-4", children: [
      /* @__PURE__ */ jsx("p", { className: "text-gray-600", children: "Select a bank account and then choose Bank Transfer to pay via bank wire. You'll receive payment instructions after placing the order." }),
      bankAccounts.length > 0 ? /* @__PURE__ */ jsxs(Fragment, { children: [
        /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
          /* @__PURE__ */ jsx("label", { htmlFor: "bank-account", className: "block text-sm font-medium text-gray-700", children: "Select Bank Account" }),
          /* @__PURE__ */ jsx(
            "select",
            {
              id: "bank-account",
              ...
              children: bankAccounts.map((bank) => /* @__PURE__ */ jsxs("option", { value: bank.id, children: [
                bank.name,
                " - ",
                bank.account_number
              ] }, bank.id))
        ...
        /* @__PURE__ */ jsx(
          Button,
          {
            ...
            children: isLoading ? "Processing..." : "Select Bank Transfer"
          }
        )
      ] }) : /* @__PURE__ */ jsx("div", { className: "bg-yellow-50 border border-yellow-200 text-yellow-700 px-4 py-3 rounded", children: "No bank accounts available. Please contact support." })
    ] }) : /* @__PURE__ */ jsxs("div", { className: "space-y-6 bg-gray-50 p-6 rounded-lg", children: [
      /* @__PURE__ */ jsxs("div", { className: "space-y-4", children: [
        /* @__PURE__ */ jsx("h3", { className: "text-lg font-semibold text-gray-800", children: "Bank Transfer Details" }),
        /* @__PURE__ */ jsxs("div", { className: "space-y-3 bg-white p-4 rounded border border-gray-200", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex justify-between", children: [
            /* @__PURE__ */ jsx("span", { className: "text-gray-600 font-medium", children: "Bank:" }),
            /* @__PURE__ */ jsx("span", { className: "text-gray-800", children: bankInfo.bankName })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "flex justify-between", children: [
            /* @__PURE__ */ jsx("span", { className: "text-gray-600 font-medium", children: "Account Holder:" }),
            /* @__PURE__ */ jsx("span", { className: "text-gray-800", children: bankInfo.accountHolder })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "flex justify-between", children: [
            /* @__PURE__ */ jsx("span", { className: "text-gray-600 font-medium", children: "Account Number:" }),
            /* @__PURE__ */ jsx("span", { className: "text-gray-800 font-mono", children: bankInfo.accountNumber })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "flex justify-between", children: [
            /* @__PURE__ */ jsx("span", { className: "text-gray-600 font-medium", children: "Bank Code:" }),
            /* @__PURE__ */ jsx("span", { className: "text-gray-800 font-mono", children: bankInfo.bankCode })
          ] }),
          bankInfo.swiftCode && /* @__PURE__ */ jsxs("div", { className: "flex justify-between", children: [
            /* @__PURE__ */ jsx("span", { className: "text-gray-600 font-medium", children: "SWIFT Code:" }),
            /* @__PURE__ */ jsx("span", { className: "text-gray-800 font-mono", children: bankInfo.swiftCode })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "flex justify-between pt-2 border-t", children: [
            /* @__PURE__ */ jsx("span", { className: "text-gray-600 font-medium", children: "Amount to Pay:" }),
            /* @__PURE__ */ jsx("span", { className: "text-lg font-bold text-green-600", children: formatPrice((cart2 == null ? void 0 : cart2.total) || 0, {
              currency: (_b = cart2 == null ? void 0 : cart2.region) == null ? void 0 : _b.currency_code
            }) })
          ] })
        ] })
      ] }),
      bankInfo.qrCodeUrl && /* @__PURE__ */ jsx("div", { className: "space-y-4", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
        /* @__PURE__ */ jsx("h3", { className: "text-lg font-semibold text-gray-800", children: "Payment QR Code" }),
        /* @__PURE__ */ jsx(
          "button",
          {
            type: "button",
      ...
      /* @__PURE__ */ jsxs("div", { className: "bg-blue-50 border border-blue-200 p-4 rounded space-y-2", children: [
        /* @__PURE__ */ jsx("h4", { className: "font-semibold text-blue-900", children: "Payment Instructions:" }),
        /* @__PURE__ */ jsxs("ol", { className: "list-decimal list-inside text-sm text-blue-800 space-y-1", children: [
          /* @__PURE__ */ jsx("li", { children: "Log into your bank account" }),
          /* @__PURE__ */ jsx("li", { children: "Create a transfer to the account details shown above" }),
          /* @__PURE__ */ jsx("li", { children: "Use your Order ID as the reference/memo" }),
          /* @__PURE__ */ jsx("li", { children: "Transfer the exact amount shown" }),
          /* @__PURE__ */ jsx("li", { children: "The admin will verify your payment and update your order status" })
        ] })
      ] }),
      /* @__PURE__ */ jsx("p", { className: "text-xs text-gray-500 text-center", children: "Your order will be marked as pending payment until verified by admin." })
    ] }),
    bankInfo && /* @__PURE__ */ jsx(
      CompleteCheckoutForm,
      {
...
function PaypalExpressCheckout() {
  const navigate = useNavigate();
  const { paymentProviders, step, cart: cart2 } = useCheckout();
  if (!cart2) return null;
...
const CheckoutPayment = () => {
  useEnv();
  const { step, paymentProviders, cart: cart2 } = useCheckout();
  const isActiveStep = step === CheckoutStep.PAYMENT;
  if (!cart2) return null;
  const hasPayPalPaymentProvider = useMemo(
    () => paymentProviders == null ? void 0 : paymentProviders.some((p) => p.id.includes("pp_paypal_paypal")),
    [paymentProviders]
  );
  const hasManualPaymentProvider = useMemo(
    () => !!(paymentProviders == null ? void 0 : paymentProviders.some((p) => p.id.includes("pp_system_default"))),
    [paymentProviders]
  );
  const hasBankTransferPaymentProvider = useMemo(
    () => !!(paymentProviders == null ? void 0 : paymentProviders.some((p) => p.id.includes("pp_bank_transfer_bank_transfer"))),
    [paymentProviders]
  );
  ...
  return /* @__PURE__ */ jsx("div", { className: "checkout-payment", children: /* @__PURE__ */ jsx("div", { className: clsx({ "h-0 overflow-hidden opacity-0": !isActiveStep }), children: /* @__PURE__ */ jsxs(Tab.Group, { children: [
    activePaymentOptions.length > 1 && /* @__PURE__ */ jsx(Tab.List, { className: "bg-primary-50 mb-2 mt-6 inline-flex gap-0.5 rounded-full p-2", children: activePaymentOptions.map((paymentOption, index) => /* @__PURE__ */ jsx(
      Tab,
      {
        as: Button,
        className: ({ selected }) => clsx("!rounded-full", {
          "!bg-white !text-gray-700 shadow-sm": selected,
          "!bg-primary-50 !border-primary-100 !text-primary-600 hover:!text-primary-800 hover:!bg-primary-100 !border-none": !selected
        }),
        children: paymentOption.label
      },
      paymentOption.id
    )) }),
    /* @__PURE__ */ jsx(Tab.Panels, { children: activePaymentOptions.map((paymentOption) => {
      const PaymentComponent = paymentOption.component;
      return /* @__PURE__ */ jsx(Tab.Panel, { children: /* @__PURE__ */ jsx(PaymentComponent, { isActiveStep, paymentMethods: [] }) }, paymentOption.id);
    }) })
  ] }) }) });
};
const CheckoutFlow = () => {
  ...
  return /* @__PURE__ */ jsx(CheckoutProvider, {
    ...
    children: /* @__PURE__ */ jsx("section", {
      children: /* @__PURE__ */ jsx("div", {
        ...
        children: /* @__PURE__ */ jsxs("div", {
          className: "flex flex-col-reverse gap-6 lg:grid lg:grid-cols-[4fr_3fr] lg:gap-x-12 xl:gap-x-16",
...
const products__index = UNSAFE_withComponentProps(function HalfFanSlider() {
  ...
  return /* @__PURE__ */ jsxs("div", {
    ...
    children: [/* @__PURE__ */ jsxs(Container, {
      className: "flex items-center justify-between mt-4 xl:mt-16",
      children: [/* @__PURE__ */ jsx("button", {
        ...
        className: "flex items-center justify-center text-4xl xl:text-[110px] font-bold leading-normal xl:leading-[114px] text-center",
      ...
      className: "flex items-center justify-end bg-white px-10 flex-1 flex-col-reverse xl:flex-row",
      children: [/* @__PURE__ */ jsx("div", {
        ...
        children: cards.map((card, i) => {
          ...
          const x = (i - (cards.length - 1)) * (isMobile ? 120 : 185);
        ...
        className: "flex flex-col justify-center h-full items-center w-full xl:w-[650px] top-0 xl:top-[-100px] relative",
          ...
          children: /* @__PURE__ */ jsxs(motion$1.div, {
            ...
            children: [activeCard.id === 1 && /* @__PURE__ */ jsx("div", {
              ...
              children: [/* @__PURE__ */ jsx("h2", {
                className: "mb-2 font-centuryBook italic text-4xl xl:text-[125px] leading-normal xl:leading-[114px] text-center",
                dangerouslySetInnerHTML: {
                  __html: activeCard.title
                }
              }), activeCard.id !== 1 && activeCard.id !== 4 && /* @__PURE__ */ jsxs("div", {
                className: "relative h-10 xl:h-20 w-10 xl:w-20",
                children: [/* @__PURE__ */ jsx("img", {
                  className: "animate-rotate-bounce absolute top-0 left-0",
                  src: "/assets/images/home/cup.svg",
                  alt: "Cup"
              ...
              className: clsx("font-title font-medium text-2xl xl:text-[75.37px] leading-normal xl:leading-[95.47px] text-center", {
...
const blogs__index = UNSAFE_withComponentProps(function BlogsIndexRoute2() {
  const data2 = useLoaderData();
  return /* @__PURE__ */ jsxs(Container, {
    className: "flex flex-col gap-6 xl:gap-12 pb-12 xl:pb-0",
    children: [/* @__PURE__ */ jsxs("div", {
      className: "flex flex-col gap-2 xl:gap-4",
      children: [/* @__PURE__ */ jsx("h1", {
        className: "text-4xl font-title font-extrabold xl:text-[110px] leading-normal xl:leading-[114px] tracking-0% text-center",
        children: "THIS IS OUR"
      }), /* @__PURE__ */ jsx("p", {
        className: "text-4xl font-centuryBook italic xl:text-[125px] leading-normal xl:leading-[114px] text-center",
        children: "Blogs"
      }), /* @__PURE__ */ jsx("p", {
        className: "text-base font-montserrat font-normal text-sm xl:text-[15px] leading-normal xl:leading-[26px] text-center max-w-3xl mx-auto",
      ...
      children: data2.posts.map((post, index) => /* @__PURE__ */ jsxs("div", {
        ...
        children: [/* @__PURE__ */ jsx("div", {
          ...
          children: [/* @__PURE__ */ jsx("h3", {
            className: "font-alexandria font-extrabold text-2xl xl:text-[49.62px] leading-normal xl:leading-[54.27px] tracking-0%",
            children: post.title
          }), /* @__PURE__ */ jsx("div", {
            dangerouslySetInnerHTML: {
...
const pickACard = UNSAFE_withComponentProps(function PickACard() {
  ...
  return /* @__PURE__ */ jsxs("div", {
    className: "min-h-screen overflow-hidden xl:overflow-visible",
    children: [/* @__PURE__ */ jsx("div", {
      className: "z-10",
      children: /* @__PURE__ */ jsxs("div", {
...
function FancyText({ id, text, className }) {
  return /* @__PURE__ */ jsxs("p", { id, className: clsx("font-centuryBook font-bold uppercase xl:hidden block", className), children: [
    /* @__PURE__ */ jsx("span", { className: "italic xl:text-[150px] text-[95px]", children: text.slice(0, 1) }),
    /* @__PURE__ */ jsx("span", { className: "font-title xl:text-[95px] text-[60px]", children: text.slice(1) })
  ] });
}
const MainMenu = () => {
  ...
  return /* @__PURE__ */ jsx("div", { className: "absolute inset-0 z-[9999] bg-white ", children: /* @__PURE__ */ jsxs("div", { className: "h-full w-full overflow-x-scroll xl:overflow-x-hidden", children: [
    /* @__PURE__ */ jsxs("div", { className: "xl:w-[1840px] w-[400vw] xl:absolute flex h-[max(calc(100vh-300px),400px)] xl:left-1/2 xl:-translate-x-1/2 items-center overflow-x-scroll xl:overflow-x-hidden", children: [
      ...
      categoryItems.map((item) => /* @__PURE__ */ jsx(
        ...
        {
          to: item.url,
          className: clsx("aspect-square w-[100vw] xl:w-auto xl:absolute", item.className),
          id: item.id,
          onMouseEnter: () => {
          ...
          children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col-reverse xl:flex-col items-center justify-center", children: [
            ...
            /* @__PURE__ */ jsx(FancyText, { id: `fancy-text-${item.id}`, className: "text-center xl:absolute text-[#FFE977] xl:text-white z-[9] xl:leading-[0]", text: item.label })
          ] })
        },
        item.id
      ))
...
const stories = UNSAFE_withComponentProps(function Stories() {
  ...
  return /* @__PURE__ */ jsxs(motion.div, {
    ...
    className: clsx("min-h-screen w-[400vw] lg:w-auto lg:aspect-[1071/256] flex [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]", isOpen ? "!w-[100vw] overflow-hidden" : ""),
    style: {
      overflow: "hidden"
    },
    initial: {
          ...
          children: items.map((item) => /* @__PURE__ */ jsxs(GridColumn, {
            ...
            children: [/* @__PURE__ */ jsxs("div", {
              ...
              children: [/* @__PURE__ */ jsx("img", {
                ...
                className: clsx("w-full absolute xl:opacity-0 opacity-100 group-hover:opacity-100 transition-all duration-300 ease-in-out", item.classNameTextWrapper),
                children: /* @__PURE__ */ jsx("p", {
...
const A = ({ isMobile }) => {
  ...
  return /* @__PURE__ */ jsx(Fragment, { children: particles.map((i, index) => /* @__PURE__ */ jsx("div", { children: /* @__PURE__ */ jsx(
    "img",
    {
      src: i.src,
      id: `particle-${i.id}`,
...
const _index = UNSAFE_withComponentProps(function IndexRoute2() {
  ...
  return /* @__PURE__ */ jsxs("div", {
    ...
    children: [/* @__PURE__ */ jsxs("div", {
      className: "flex gap-11 justify-between absolute top-0 left-0 w-full px-4 lg:px-11 pt-8 z-10",
      children: [/* @__PURE__ */ jsxs("p", {
      ...
      children: [activeComponent !== "main" && /* @__PURE__ */ jsx("div", {
        className: "z-10 h-[48px] lg:h-[80px]"
...
const routes = {
  ...
  "routes/api.checkout.payment-session": {
    id: "routes/api.checkout.payment-session",
    parentId: "root",
    path: "api/checkout/payment-session",
    index: void 0,
    caseSensitive: void 0,
    module: route7
  },
