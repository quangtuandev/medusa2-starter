...
const IconButton = ({ icon: Icon, className, iconProps, ...props }) => /* @__PURE__ */ jsx(
  ButtonBase,
  {
    ...
    ...props,
    children: /* @__PURE__ */ jsx(Icon, { ...iconProps, className: clsx(iconProps == null ? void 0 : iconProps.className, "h-6 w-6 text-current") })
  }
);
      ...
      /* @__PURE__ */ jsxs(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap-reverse items-center gap-x-6 sm:justify-end", children: [
              headerNavigationItems2 && /* @__PURE__ */ jsx("div", { className: "hidden h-full gap-6 md:flex", children: headerNavigationItems2.slice(0, 6).map(({ id, new_tab, ...navItemProps }, index) => /* @__PURE__ */ jsx(
                URLAwareNavLink,
                {
                  ...navItemProps,
                  newTab: new_tab,
