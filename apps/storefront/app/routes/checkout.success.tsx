  ...
  return (
    <>
      <div className="bg-[url('/assets/images/checkout/success-bg.png')] bg-contain bg-center contact-success-message text-center mt-8">
        <p className="text-[80px] xl:text-[150px] font-centuryBook italic">{t('success.hurray')}</p>
        <p className="text-[55px] xl:text-[110px] font-title font-bold">{t('success.weGotU')}</p>
        <p className="text-[28px] xl:text-[30px] font-title font-light">{t('success.deliveringSweetness')}</p>
      </div>
