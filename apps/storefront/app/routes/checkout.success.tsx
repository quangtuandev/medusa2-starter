  ...
  return (
    <Container>
      <div className="bg-[url('/assets/images/checkout/success-bg.png')] bg-contain lg:bg-center bg-no-repeat contact-success-message text-center mt-8">
        <p className="text-[65px] xl:text-[120px] font-centuryBook italic">{t('success.hurray')}</p>
        <p className="text-[30px] xl:text-[70px] font-title font-bold">{t('success.weGotU')}</p>
