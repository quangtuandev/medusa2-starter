...
export default function BlogsIndexRoute() {
  ...
  return (
    <Container className="flex flex-col gap-6 xl:gap-12 pb-12 xl:pb-0">
      <div className="flex flex-col gap-2 xl:gap-4">
        ...
        <p className="text-4xl font-centuryBook italic xl:text-[125px] leading-normal xl:leading-[114px] text-center">Blogs</p>
