...
export default function PickACard() {
  ...
  const initialCards = useMemo(() => [
    {
      id: 4, h1: t('products.newMagic'),
      animate: { x: '90px', y: '280px', rotate: '35deg', zIndex: 0, skewX: -25, skewY: 10 },
      title: t('products.coming'), component: () => <ComingCollection isActive={false} className="w-[230px] h-[380px] h-sm:w-[184px] h-sm:h-[304px]" />
    },
    {
      id: 3, h1: t('products.thisIsOur'),
      animate: { x: '100px', y: '155px', rotate: '10deg', zIndex: 0, skewX: -15, skewY: 0 },
      title: t('products.icy'), component: () => <IcyCollection isActive={false} className="w-[230px] h-[380px] h-sm:w-[184px] h-sm:h-[304px]" />
    },
    {
      id: 2, h1: t('products.thisIsOur'),
      animate: { x: '-100px', y: '55px', rotate: '-10deg', zIndex: 0, skewX: 15, skewY: 0 },
      title: t('products.thirsty'), component: () => <ThirstyCollection isActive={false} className="w-[200px] h-[330px] h-sm:w-[164px] h-sm:h-[270px]" />
    },
    {
      id: 1, h1: t('products.thisIs'),
      animate: { x: 0, y: 0, rotate: '-10deg', zIndex: 0, skewX: 3, skewY: 0 },
      title: t('products.all'), component: () => <AllCollection isActive={false} className="w-[200px] h-[336px] h-sm:w-[164px] h-sm:h-[276px]" />
    },
  ], [t]);
