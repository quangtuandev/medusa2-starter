    ...
    return (
        <Container>
            <div className="contact-success-message text-center mt-8">
                <p className="text-[65px] xl:text-[150px] font-centuryBook italic leading-48px pl-2">{t('success.oohh')}</p>
                <p className="text-[30px] xl:text-[110px] font-title font-bold leading-48px pl-2">{t('success.uGotSomething')}</p>
            </div>
