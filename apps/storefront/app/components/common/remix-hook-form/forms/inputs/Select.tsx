...
export const Select = forwardRef<HTMLSelectElement, SelectProps>(
  ({ options, children, className, error, ...props }, ref) => (
    <select
      ...
      {...props}
      className={clsx(
        'focus:ring-primary-500 focus:border-primary-500 block h-12 w-full  rounded-md border border-gray-300 pl-3 pr-10 text-sm shadow-sm outline-none focus:ring-1',
