...
export const A = ({ onLetterClick, onMouseEnterLetter, onMouseLeaveLogo }: LogoProps) => {
    const { t } = useI18n();
    ...
    return (
        <>
            <div className="flex relative flex-col items-center gap-4 ">
                ...
                <Logo className="z-10 i-hover" fill="#321D14" activeLetter="A" onLetterClick={onLetterClick} onMouseEnterLetter={onMouseEnterLetter} onMouseLeaveLogo={onMouseLeaveLogo} />
                <Description className="z-10 mt-16 max-w-[590px]" description={t('home.a.description')} />
            </div>
