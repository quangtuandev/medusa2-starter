    ...
    >
      ...
      <span className={clsx(
        "text-nowrap btn-add text-xs lg:text-base",
        {
          ...
          "opacity-0 w-0 h-0 hidden transition-all duration-300 group-hover/product-card:opacity-100 group-hover/product-card:w-auto group-hover/product-card:h-auto group-hover/product-card:block": !isFullText,
        }
