...
export interface ProductItemProps extends HTMLAttributes<HTMLElement> {
...
export const ProductItem: FC<ProductItemProps> = ({
  ...
  return (
    <article
      className={clsx(className, "text-left rounded-[32px] p-4 pb-6 overflow-hidden bg-white shadow-[5px_5px_10px_0px_#00000040]")}
      {...props}
    >
      ...
      <h4 className="mt-4 overflow-hidden text-ellipsis font-extrabold font-title  transition-all duration-300 text-[28px]">
        {product.title}
      </h4>
      ...
      <p className="mt-1 text-lg font-extrabold font-title leading-none tracking-normal">
